<template>
  <div class="geo">
    ...
    <h1 class="title">判断一个或多个坐标是否在指定条件的电子围标内，并返回查到的围栏集合，坐标满足其中任意一个围栏即可</h1>
    <h2>接口使用说明</h2>
      ...
      tableData: [
        {
          ...
          mean: 'Coordinate {lat (number, optional),lng (number, optional)}。 坐标集合，如果judgeAddressType为true，严格按照出发地、途经点、目的地的顺序：第一个坐标为出发地，最后一个坐标为目的地，中间的为途经点',
