<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>分页获取围栏</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">分页获取围栏</h1>
    <h2>接口使用说明</h2>
    <h3>分页获取围栏接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/fence/page</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getFencePageData } from 'network/fence'
export default {
  data() {
    return {
      isRun: false,
  ...
  methods: {
    run() {
      ...
      getFencePageData(this.bypointObj).then(res => {
        this.content = res
      })
    }
  }
