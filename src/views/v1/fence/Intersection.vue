<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>是否存在交集</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">工具接口，判断一个多边形与一组多边形是否存在交集</h1>
    <h2>接口使用说明</h2>
    <h3>工具接口，判断一个多边形与一组多边形是否存在交集接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/fence/is-intersection</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getIntersectionData } from 'network/fence'
export default {
  data() {
    return {
      isRun: false,
