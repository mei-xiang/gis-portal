<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>批量接驾计算</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">批量接驾计算</h1>
    <h2>接口使用说明</h2>
    <h3>批量接驾计算接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/route/compute</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getComputeData } from 'network/route'
export default {
  data() {
    return {
      isRun: false,
  ...
  methods: {
    run() {
      ...
      getComputeData(
        ...
        JSON.parse(this.exptableData[1].value)
      ).then(res => {
        this.content = res
      })
    }
