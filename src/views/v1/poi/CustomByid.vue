<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>查询详情</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">自定义上下车点:查询详情</h1>
    <h2>接口使用说明</h2>
    <h3>查询详情接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/poi/custom/byid?poiId=&poiBizTypeEnum=</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getCustomByidData } from 'network/poi'
export default {
  data() {
    return {
      isRun: false,
      tableData: [
        ...
        {
          param: 'poiBizTypeEnum',
          mean: '业务枚举。AUTO_DRIVER/LIFT',
          type: 'String',
          request: '必填'
        }
      ],
  ...
  methods: {
    run() {
      this.isRun = true
      getCustomByidData(
        this.exptableData[0].value,
        this.exptableData[1].value
      ).then(res => {
        this.content = res
      })
    }
