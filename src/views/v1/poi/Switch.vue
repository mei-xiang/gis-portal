<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>开启或者关闭</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">自定义的上下车点:开启或者关闭</h1>
    <h2>接口使用说明</h2>
    <h3>开启或者关闭接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/poi/custom/status-switch</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getSwitchData } from 'network/poi'
export default {
  data() {
    return {
      isRun: false,
  ...
  methods: {
    run() {
      ...
      getSwitchData(this.condtionObj).then(res => {
        this.content = res
      })
    }
  }
