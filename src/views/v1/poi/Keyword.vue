<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>poi关键字检索</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">poi关键字检索,暂不支持bizType为2</h1>
    <h2>接口使用说明</h2>
    <h3>poi关键字检索</h3>
    <h4>请求地址</h4>
    <p>http://{{domainName}}:8080/v1/poi/keyword</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
    ...
    return {
      ...
      tableData: [
        ...
        },
        {
          param: 'bizType',
          mean:
            '暂支持的业务类型：1，快享、专享 3，自动驾驶， 99，T3 ；默认为 1',
          type: 'Integer',
          request: '必填'
        },
        {
