<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>附近车辆</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">附近车辆</h1>
    <h2>接口使用说明</h2>
    <h3>附近车辆接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/vehicle/cars</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getCarsData } from 'network/vehicle'
export default {
  data() {
    return {
      isRun: false,
  ...
  methods: {
    run() {
      ...
      // 通过类整合数据
      // this.carObj = new Condtion(this.exptableData)
      getCarsData(this.carObj).then(res => {
        this.content = res
      })
    }
  }
