<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>删除站点信息</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">删除站点信息</h1>
    <h2>接口使用说明</h2>
    <h3>删除站点信息接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/site/delete?id=</p>
    <h4>请求方法</h4>
    <p>DELETE</p>
    <h4>请求</h4>
...
<script>
import { deleteData } from 'network/site'
export default {
  data() {
    return {
      isRun: false,
  ...
  methods: {
    run() {
      this.isRun = true
      deleteData(Number(this.exptableData[0].value)).then(res => {
        this.content = res
      })
    }
  }
