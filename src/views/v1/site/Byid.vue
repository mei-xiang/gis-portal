<template>
  <div class="geo">
    ...
    <h3>查询详情接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/site/byid</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getByidData } from 'network/site'
export default {
  data() {
    return {
      isRun: false,
      ...
      ExptableData: [
        {
          param: 'uuid',
          value: '5d83441b23b107299f82555f',
          mean: 'T3 转换暂时只有城市编码和行政区编码',
          request: '必填'
        }
      ],
      content: ''
  ...
  methods: {
    run() {
      this.isRun = true
      getByidData(this.ExptableData[0].value).then(res => {
        this.content = res
      })
    }
  }
