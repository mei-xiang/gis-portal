<template>
  <div class="geo">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>同步服务站点信息到GIS</el-breadcrumb-item>
    </el-breadcrumb>
    <h1 class="title">同步服务站点信息到GIS</h1>
    <h2>接口使用说明</h2>
    <h3>同步服务站点信息到GIS接口</h3>
    <h4>请求地址</h4>
    <p>http://192.168.44.152:8080/v1/site/sync</p>
    <h4>请求方法</h4>
    <p>POST</p>
    <h4>请求</h4>
...
<script>
import { getSyncData } from 'network/site'
export default {
  data() {
    return {
      isRun: false,
  ...
  methods: {
    run() {
      ...
      getSyncData([this.condtionObj]).then(res => {
        this.content = res
      })
    }
  }
